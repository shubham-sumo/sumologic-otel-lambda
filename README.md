...
- Java wrapper layer contains OpenTelemetry Java `v2.29.0` and OpenTelemetry Collector `v0.156.0`. Please see list of [lambda layers](https://github.com/SumoLogic/sumologic-otel-lambda/blob/release-java-v2.20.0/java/README.md).
...
- Python layer contains OpenTelemetry Python SDK `v1.43.0` with instrumentation `v0.64b0` and OpenTelemetry Collector `v0.156.0`. Please see list of [lambda layers](https://github.com/SumoLogic/sumologic-otel-lambda/blob/release-python-v1.41.0/python/README.md).
