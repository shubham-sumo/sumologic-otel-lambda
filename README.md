...
- NodeJS layer contains OpenTelemetry JavaScript SDK `v2.9.0` and OpenTelemetry Collector `v0.156.0`. Please see list of [lambda layers](https://github.com/SumoLogic/sumologic-otel-lambda/blob/release-nodejs-v2.1.0/nodejs/README.md).
